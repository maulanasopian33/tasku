<!-- MODAL  -->
  <div class="modal fade rounded-0" id="dial_mapel">
      <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
              <div class="modal-header bg-primary text-white">
                  <h5 class="modal-title">Tambahkan Mapel</h5>
              ...
              <div class="modal-body">
                ...
                <div class="basic-form input-primary-o">
                    <form id="tambahM" action="/admin/mapel/simpan" method="POST">
                      @csrf
                        <div class="mb-3">
                            <span class="p-2" for="namamapel">Nama Mapel</span>
                            <input id="namamapel"  name="nama mapel" type="text" class="form-control input-rounded" placeholder="masukan nama mapel">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="fnamaguru" hidden name="nama guru">
                            <div class="dropdown hierarchy-select" id="namaguru">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" form="tambahM" class="btn btn-primary">Simpan Mapel</button>
              </div>
          </div>
      </div>
</div>