...
<head>
	...
	<meta name="author" content="PucukIdea">
    ...
    <div id="main-wrapper">
       ...
       <div class="nav-header">
            <a href="index.html" class="brand-logo">
				...
				<div class="brand-title">
					<h2 class="">Tasku</h2>
					<span class="brand-sub-title">Sistem managemen peserta didik</span>
				</div>
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="https://ui-avatars.com/api/?background=0D8ABC&color=fff&bold=true&name={{ urlencode(auth()->user()->name) }}" width="56" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
     ...
     {{--    @include('Parsial.slidebarbase2') --}}
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="/" target="_blank">PucukIdea</a> 2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end
