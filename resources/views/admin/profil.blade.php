...
<div class="container-fluid">
    <div class="row page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="{{ route('dashboard admin')}}">Admin</a></li>
                                            ...
                                            <form>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-md-4">
                                                        ...
                                                        </select><div class="nice-select form-control default-select wide" tabindex="0"><span class="current">Choose...</span><ul class="list"><li data-value="Choose..." class="option selected">Choose...</li><li data-value="Option 1" class="option">Option 1</li><li data-value="Option 2" class="option">Option 2</li><li data-value="Option 3" class="option">Option 3</li></ul></div>
                                                    </div>
